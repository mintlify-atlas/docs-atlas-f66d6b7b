...
<Note>
The Grid API provides 100+ methods for controlling the grid programmatically. See the [API Reference](/api/grid-api) for the complete list.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Row Selection" icon="check-square" href="/features/selection">
    Enable row and cell selection in your grid
  </Card>
  <Card title="Cell Editing" icon="pen" href="/features/editing">
